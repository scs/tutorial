...
int main(const int argc, const char * argv[])
{
  ...
  /* Configure camera */
  OscCamPresetRegs();
  OscCamSetAreaOfInterest(0,0,OSC_CAM_MAX_IMAGE_WIDTH,
						  OSC_CAM_MAX_IMAGE_HEIGHT);
  OscCamSetFrameBuffer(0, OSC_CAM_MAX_IMAGE_WIDTH*OSC_CAM_MAX_IMAGE_HEIGHT,
					   frameBuffer, TRUE);
  ...
  OscVisDebayer(&rawPic, OSC_CAM_MAX_IMAGE_WIDTH,
				OSC_CAM_MAX_IMAGE_HEIGHT, enBayerOrder, &colorPic);
